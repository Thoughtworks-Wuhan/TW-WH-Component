...
class AdvancedSearch extends Component {
    ...
    getStages = () => ['Closed Won', 'Contract Negotiation', 'Proposal componment', 'item1', 'item2', 'item3'];
                ...
                <div className="search-criterion">
                    <div className="criterion-details" id="keyword">
                        ...
                        <div className="text-left"><input
                            className="stage-option form-input"
                            placeholder="Opportunity, Account name"
                            title=""
                        /><span
                            ...
                            <div className="criterion-details">
                                ...
                                <div className="expand-container">
                                    <div className="probability-container"><span className="percentage-sign"><input
                                        className="numeric form-input"
                                        id="min-prob"
                                        maxLength="3"
                                    /></span><span>&nbsp;
                                        To&nbsp;</span><span className="percentage-sign"><input
                                        className="numeric form-input"
                                            id="max-prob"
                                            maxLength="3"
                                        /></span>
                                    </div>
                                    <span className="validation-message" /></div>
                            </div>
                            <div className="criterion-details">
                                <div className="criterion-title"><span
                                    className="criterion-fields-set"
                                >Start Date / End Date</span></div>
                                <div className="expand-container">
                                    ...
                                    <div className="multiple-checkbox-container">
                                        <div className="region-button-dropbox">
                                            <button className="dropbox-button region-button">
                                                <span className="stage-icon"><span >select region(s)</span></span></button>
                                            <div className="multiple-checkbox-dropbox region-dropbox">
                                                <ul>
                                                    <li><label htmlFor="australia">
                                                        <input id="australia" className="stage-option" type="checkbox" value="Australia" title="" />
                                                        <span className="validationMessage" />
                                                        <span >Australia</span></label></li>
                                                    <li><label htmlFor="brazil"><input id="brazil" className="stage-option" type="checkbox" value="Brazil" title="" /><span
                                                        className="validationMessage"
                                                    /><span >Brazil</span></label></li>
                                                    <li><label htmlFor="canada"><input id="canada" className="stage-option" type="checkbox" value="Canada" title="" /><span
                                                        className="validationMessage"
                                                    /><span >Canada</span></label></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
